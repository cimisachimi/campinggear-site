  ...
  <section>
    <div className="flex flex-col xl:flex-row gap-x-8 gap-14 mt-5 sm:m-4 md:m-4 xl:m-4 xs:m-4">
        ...
        <div className="flex flex-col gap-[7px] flex-wrap  ">
          <img src={product.image} className="w-full bg-cover h-3/5"  alt="Product" />
    ...
    <div className="flex flex-col gap-y-6">
        ...
        <div className="space-y-2 bold-16">
          ...
          <div className=" flex gap-x-2">
              <div className="ring-2 ring-slate-600 h-10 w-10  cursor-pointer flexCenter text-slate-800 hover:bg-black hover:text-slate-200">S</div>
              <div className="ring-2 ring-slate-600 h-10 w-10 flexCenter cursor-pointer  text-slate-800 hover:bg-black hover:text-slate-200">M</div>
              <div className="ring-2 ring-slate-600 h-10 w-10 flexCenter cursor-pointer  text-slate-800 hover:bg-black hover:text-slate-200">L</div>
              <div className="ring-2 ring-slate-600 h-10 w-10 flexCenter cursor-pointer  text-slate-800 hover:bg-black hover:text-slate-200">XL</div>
              <div className="ring-2 ring-slate-600 h-10 w-10 flexCenter cursor-pointer  text-slate-800 hover:bg-black hover:text-slate-200">XXL</div>
          </div>
        </div>
